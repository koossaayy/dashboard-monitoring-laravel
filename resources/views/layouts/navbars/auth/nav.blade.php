    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar">
            ...
            <li class="nav-item d-flex align items-center">
                <a class="nav-link text-body font-weight-bold px-0 me-2" id="navbar-clock">
                </a>
            </li>
            <li class="nav-item d-flex align-items-center">
            ...
            <li class="nav-item d-flex align-items-center">
                <a href="" class="nav-link logout-btn text-body font-weight-bold px-0">
                    <i class="fas fa-sign-out-alt m-1 text-danger"></i>
                </a>
            </li>
            </ul>
        </div>
