    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="{{ (Request::is('rtl') ? 'float-end' : 'float-start') }}">
          <h5 class="mt-3 mb-0">{{ __('Soft UI Configurator') }}</h5>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <div class="d-flex">
          <button class="btn bg-gradient-primary w-100 px-3 mb-2 active" data-class="bg-transparent" onclick="sidebarType(this)">{{ __('Transparent') }}</button>
          <button class="btn bg-gradient-primary w-100 px-3 mb-2  {{ (Request::is('rtl') ? 'me-2' : 'ms-2') }}" data-class="bg-white" onclick="sidebarType(this)">{{ __('White') }}</button>
        </div>
        <p class="text-sm d-xl-none d-block mt-2">{{ __('You can change the sidenav type just on desktop view.') }}</p>
        <!-- Navbar Fixed -->
        <div class="mt-3">
